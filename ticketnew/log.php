...
$result ="SELECT * FROM it_ticket_service Where Status='Open' AND Tech_id='Not Assigned'";
...
<body>
	<form method="post" action="filter.php">
	  ...
	  <select style="padding:5px;" name="lab">
		...
		<option disable='disabled'>Select PC</option>
		<option>1</option>
		<option>2</option>
		<option>3</option>
		<option>4</option>
...
?>
		...
		<option value="T101">Technician-1</option>
							...
							<button id="submit" type="submit" name="submit">Do</button>
											...
											<button id="btnExport" type="submit" name="go">Export To Excel</button>
											</form>
							<div class="clear"></div>
						</div>
