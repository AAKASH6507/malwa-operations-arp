...
$result ="SELECT * FROM it_ticket_service Where Tech_id='Not Assigned' OR Status='Open'";
	...
	<form method="post" action="filter.php">
		...
		<div class="right-border">
			<div class="page-wrapper">
				<div id="header">
					<div id="header-design">
						...
						<div id="header-right">
							...
							<a href="index.php" class="button logout">Logout</a>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
						</div>
				...
				<div id="menu">
					<ul id="nav">
					<li><a href="log.php"><span>Tickets</span></a>
								<ul>
									<li><a href="add.php"><span>Add</span></a></li>
								</ul>
					</li>
					<li><a href="#"><span>Profile</span></a></li>
					<li><a href="log2.php"><span>Details</span></a></li>
