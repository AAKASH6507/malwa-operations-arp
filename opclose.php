...
$i=$_GET['x'];
$result ="SELECT * FROM it_ticket_service WHERE Status='".$i."'";
...
<body>
		...
		<div class="right-border">
			...
			<div id="ticket-details" class="widget">
				...
				<div class="clear"></div>
				<div class="clear">
			<p class="label short"><a href="opclose.php?x=Pending" >Pending Tickets</a>
	  ...
	  <select style="padding:5px;" name="lab">
		...
		<button id="ok" type="submit" name="go">Search</button>
				...
				<div class="clear"></div>
					...
					<form method="post" action="opop.php">
				<p>
...
while($record = mysqli_fetch_array($mydata))
{
	$id1=$record['T_id'];
echo "<tr>";
echo "<td>" ."<input type='checkbox' id='checkbox' value='$id1' name='checkbox[]' />". "</td>";
...
echo "<td>" .$record['Tech_assigned'] ."</td>";
