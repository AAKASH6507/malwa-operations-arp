	...
	*/
	...
	(min-device-width: 768px) and (max-device-width: 1024px)  {
		...
		*/
		...
		td:nth-of-type(2):before { content: "Added"; }
		td:nth-of-type(3):before { content: "Lab NO"; }
		td:nth-of-type(4):before { content: "Pc_no";  }
		td:nth-of-type(5):before {content: "Assign Technician"; }
...
<form method="post" action="filter.php">
		...
		<div class="right-border">
			...
			<div id="ticket-details" class="widget">
				...
				<div class="clear"></div>
				<div class="clear">
			<p class="label short"><a href="opclose.php?x=open" >Open Tickets</a>
	

				<a href="opclose.php?x=closed">Closed Tickets</a>
				<a href="opclose.php?x=Pending" >Pending Tickets</a>
				</p></div>
...
if(isset($_POST['go']) && (isset($_POST['lab'])) && (isset($_POST['pc']) )&& (isset($_POST['tech']))){
  $l=$_POST['lab'];
  $p=$_POST['pc'];
  $t=$_POST['tech'];
  
  $result ="SELECT * FROM it_ticket_service WHERE Lab_no='".$l."' OR Pc_no='".$p."' OR Tech_id='".$t."'" ;
