		...
		<div class="right-border">
			<div class="page-wrapper">
				...
				<div id="menu">
					...
					<ul>
									<li><a href="tech.php"><span>Technician</span></a></li>
...
{
	$l=$_POST['pc'];
$result ="SELECT * FROM it_ticket_service Where Pc_no='".$l."'";
$mydata = mysqli_query($conn,$result);
 $query = "SELECT COUNT(*) as totalno FROM it_ticket_service where Pc_no='".$l."'";
